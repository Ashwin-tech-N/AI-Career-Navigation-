...
import { Check, Lock, Star, Sparkles, ChevronRight, Target, Map, Code, Database, Shield, Cloud, BrainCircuit, X, Play, MessageSquare, UserCheck } from './ui/Icons';
...
const TrainingMode: React.FC<TrainingModeProps> = ({ modules, selectedCareer, onCareerConfirm, onModuleComplete }) => {
